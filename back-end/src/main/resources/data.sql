...
insert ignore into db_example.university (location, name, about, image_url) values
  ('Orlando', 'University Of Central Florida', "The University of Central Florida, or UCF, is an American metropolitan public research university in Orlando, Florida.", "https://lh3.googleusercontent.com/-XaqFLJsRmcs/AAAAAAAAAAI/AAAAAAAADJ4/Vo1r132n4zM/s0-c-k-no-ns/photo.jpg")
  ,('Gainesville', 'University of Florida', "The University of Florida is an American public land-grant, sea-grant, and space-grant research university on a 2,000-acre campus in Gainesville, Florida.", "https://made.it.ufl.edu/media/templates/tech-template/img/UF-Signature.png")
  ...
  ,('Pensacola', 'University of West Florida', "The University of West Florida, also known as West Florida and UWF, is a mid-sized public university located in Pensacola, Florida, United States.", "http://pensacolachamber.com/wp-content/uploads/2012/05/UWF-logo-blue.jpg")
  ...
  ,('Orlando', 'Full Sail', "Located in Winter Park, Florida, Full Sail University offers associate's, bachelor's, and master's degrees designed for the world of entertainment, media, arts, and technology.","https://upload.wikimedia.org/wikipedia/en/thumb/7/7d/Full_Sail_University.svg/1200px-Full_Sail_University.svg.png")
  ,('Orlando', 'Valencia', "Valencia provides opportunities for academic, technical and life-long learning in a collaborative culture dedicated to inquiry, results and excellence.","http://valenciacollege.edu/images/logos/valencia-college-logo.svg")
  ...
  ,('Fort Myers', 'Florida Gulf Coast University', "Florida Gulf Coast University is a public university located in Fort Myers, Florida, United States, part of unincorporated Lee County. The university belongs to the 12-campus State University System of Florida.", "https://upload.wikimedia.org/wikipedia/en/thumb/1/19/FGCU_official_seal.svg/1024px-FGCU_official_seal.svg.png")
...
insert IGNORE into db_example.user (name, email, password) values
  ("Felicity","Felicity.Pullman@knights.ucf.edu","OnY16ivP"), ("Sarah","Sarah.Turner@ufl.edu","cOKJgi8A"), ("David","David.Berry@usf.edu","UtUXW0E4"), ("Phil","Phil.Taylor@uwf.edu","bZ5g13?M"), ("Keith","Keith.Slater@uef.edu","10Y8C3BW")
  , ("Dan","Dan.Kelly@fullsail.edu","q4Ld#oS?"), ("Felicity","Felicity.Taylor@valencia.edu","d?YJkqIJ"), ("Christian","Christian.Carr@fiu.edu","8!NRqLWY"), ("Connor","Connor.May@fgu.edu","JzNHW9OC"), ("Jennifer","Jennifer.MacDonald@famu.edu","C6B6ABAV")
  , ("Yvonne","Yvonne.Chapman@knights.ucf.edu","QIW9uo2A"), ("Caroline","Caroline.Duncan@ufl.edu","a58GJIv!"), ("Oliver","Oliver.Gill@usf.edu","3ZAEKKVG"), ("Joanne","Joanne.Edmunds@uwf.edu","A,FBEKJ4"), ("Dorothy","Dorothy.Ferguson@uef.edu","lyj#6ePx")
  , ("Michelle","Michelle.Brown@fullsail.edu","5OEhIWfw"), ("Lucas","Lucas.Powell@valencia.edu","ONt30ht5"), ("Liam","Liam.Avery@fiu.edu","8IZlPHr8"), ("John","John.Butler@fgu.edu","0#7n,OPz"), ("Justin","Justin.Sharp@famu.edu","TQgAzMO5")
  , ("Gordon","Gordon.Hardacre@knights.ucf.edu","a7!uBIsV"), ("Harry","Harry.Davies@ufl.edu","bUupCT96"), ("Joshua","Joshua.Terry@usf.edu","cvbH?nfg"), ("Rose","Rose.Paterson@uwf.edu","JaqUX6Mi"), ("Claire","Claire.Springer@uef.edu","kvKc-4pW")
  , ("Cameron","Cameron.Rampling@fullsail.edu","HCDSKjqi"), ("Jason","Jason.Miller@valencia.edu","iz't4PfQ"), ("Andrea","Andrea.Russell@fiu.edu","5q6'CJ#Z"), ("Lily","Lily.Kerr@fgu.edu","pnhQWnqi"), ("Oliver","Oliver.McDonald@famu.edu","YnAaCELu")
  , ("Jacob","Jacob.Edmunds@knights.ucf.edu","7w.mNqf0"), ("Leonard","Leonard.Piper@ufl.edu","2HHfpMN."), ("Jennifer","Jennifer.Newman@usf.edu","5MKtYw4T"), ("Dan","Dan.Pullman@uwf.edu","-U-UsZg."), ("Oliver","Oliver.Buckland@uef.edu","oxJTpQA.")
  , ("Benjamin","Benjamin.MacLeod@fullsail.edu","qA?'GACZ"), ("Benjamin","Benjamin.Underwood@valencia.edu","AiQ6sOxm"), ("Jacob","Jacob.Cornish@fiu.edu","7cKso9Co"), ("Caroline","Caroline.Henderson@fgu.edu","avuHtcKm"), ("Bella","Bella.Young@famu.edu",",A!vVX7K")
  , ("Angela","Angela.Greene@knights.ucf.edu","saMc?eR7"), ("Una","Una.MacDonald@ufl.edu","v,NB2bdm"), ("Penelope","Penelope.Peake@usf.edu","?cL5J6ZW"), ("Nicholas","Nicholas.Carr@uwf.edu","6o8heBP!"), ("Katherine","Katherine.Hill@uef.edu","!fWX'mse")
  , ("Warren","Warren.Berry@fullsail.edu","!5nR9'ED"), ("Gordon","Gordon.McDonald@valencia.edu","WB55d-M?"), ("Stewart","Stewart.Taylor@fiu.edu","NriWBFBR"), ("Lauren","Lauren.Edmunds@fgu.edu","HTtw16p4"), ("Jason","Jason.Kelly@famu.edu","iiR0cF10")
  , ("Anna","Anna.Hamilton@knights.ucf.edu","w?1ijLkh"), ("Bernadette","Bernadette.Berry@ufl.edu","53G6.1ji"), ("Anthony","Anthony.Dickens@usf.edu","TCDWgMHB"), ("Thomas","Thomas.Sutherland@uwf.edu","BM!N!rNd"), ("Jessica","Jessica.Stewart@uef.edu","fvRVum,l")
  , ("Faith","Faith.Poole@fullsail.edu","fNbPwgyH"), ("Max","Max.Grant@valencia.edu","nXm'PJZP"), ("Andrew","Andrew.Greene@fiu.edu","iio4Ymff"), ("Amelia","Amelia.Ince@fgu.edu","P8lW!Gxs"), ("Jacob","Jacob.Lee@famu.edu","#uTIcY4h")
  , ("Stewart","Stewart.Duncan@knights.ucf.edu","!O0eIlbA"), ("Ian","Ian.Hudson@ufl.edu","hDHRj'FS"), ("Gabrielle","Gabrielle.Lawrence@usf.edu","NkovBAVk"), ("Edward","Edward.Hudson@uwf.edu","qTYg.9G2"), ("Theresa","Theresa.MacLeod@uef.edu","cnqDU6I-")
  , ("Carolyn","Carolyn.Sanderson@fullsail.edu","ffw#ihTi"), ("Yvonne","Yvonne.Gray@valencia.edu","OkO2QeNo"), ("Natalie","Natalie.Scott@fiu.edu","tzcHLQvO"), ("Richard","Richard.Allan@fgu.edu","VyEfJkYH"), ("Liam","Liam.Alsop@famu.edu","M-2h2#ks")
  , ("Sam","Sam.Grant@knights.ucf.edu","Q7jPLRFq"), ("Maria","Maria.Randall@ufl.edu","uErXHd6x"), ("Amanda","Amanda.Knox@usf.edu","ZV'nRo'E"), ("Carol","Carol.Wright@uwf.edu","PW?va-ev"), ("Tracey","Tracey.Smith@uef.edu","ws2r1yDU"), ("Sophie","Sophie.Gibson@fullsail.edu",".vZqZ00p")
  , ("Jan","Jan.Lewis@valencia.edu","4xU,.jiX"), ("Fiona","Fiona.Hill@fiu.edu","#xf4Y9Mw"), ("Adrian","Adrian.King@fgu.edu","DOX5Qmrr"), ("Megan","Megan.Ferguson@famu.edu","2M.jbiiH"), ("Megan","Megan.Rees@knights.ucf.edu","HL#VTnIM"), ("Maria","Maria.Rutherford@ufl.edu","DvVR!Dxb")
  , ("William","William.Skinner@usf.edu","A-K16GE?"), ("Wendy","Wendy.Hart@uwf.edu","niLtiO9p"), ("Amy","Amy.Jackson@uef.edu","h5y4hY.!"), ("Jonathan","Jonathan.Morrison@fullsail.edu","uxNcRECf"), ("Wanda","Wanda.Quinn@valencia.edu","965RCje,"), ("Lily","Lily.Forsyth@fiu.edu","1UtYY99Y")
  , ("Lauren","Lauren.Paige@fgu.edu",",1-?JqB5"), ("Amelia","Amelia.Mills@famu.edu","Oy,eHDFB"), ("Alexander","Alexander.Lyman@knights.ucf.edu","iwL7n3A1"), ("Ryan","Ryan.Ellison@ufl.edu","I1JdnZHo"), ("Trevor","Trevor.Slater@usf.edu","EAZVSR8n"), ("Jonathan","Jonathan.Cameron@uwf.edu","jq6cws'3")
  , ("Blake","Blake.Dickens@uef.edu","Wor91kDS"), ("Carl","Carl.Quinn@fullsail.edu","UZfFdy##"), ("Frank","Frank.Lawrence@valencia.edu","UgTf7K#x"), ("Connor","Connor.Mills@fiu.edu","CPFONC9Z"), ("Zoe","Zoe.Wright@fgu.edu","5Scs.lKc"), ("Jan","Jan.Lee@famu.edu","vcvBFklo")
  , ("Theresa","Theresa.Piper@knights.ucf.edu","smV,ZTXI"), ("Sue","Sue.Turner@ufl.edu","QLHQ7pVJ"), ("Rose","Rose.McDonald@usf.edu","5d,9U9iR"), ("Adam","Adam.Newman@uwf.edu","m8mNtovb"), ("Sarah","Sarah.Berry@uef.edu","RdP!R.kK"), ("Richard","Richard.Kelly@fullsail.edu","H8,2?o-b")
  , ("James","James.Wilkins@valencia.edu","haEeb83,"), ("James","James.Hart@fiu.edu","2Yd5N6LQ"), ("Max","Max.Fisher@fgu.edu","v72'Ig6p"), ("Olivia","Olivia.Berry@famu.edu","38eVl9h9"), ("Natalie","Natalie.Pullman@knights.ucf.edu","uydWx6d-"), ("Diana","Diana.Jackson@ufl.edu","UY#26uT5")
  , ("Mary","Mary.James@usf.edu","eukqc4WF"), ("Natalie","Natalie.Murray@uwf.edu","7oyfSUn3"), ("Audrey","Audrey.Avery@uef.edu","1.3YTZ#N"), ("Robert","Robert.Hart@fullsail.edu","AjBZ2GGq"), ("Lauren","Lauren.MacLeod@valencia.edu","q5K28FJF"), ("Connor","Connor.Hunter@fiu.edu","O9!koPQx")
  , ("Joe","Joe.Henderson@fgu.edu","1-MAdjB,"), ("Stewart","Stewart.Marshall@famu.edu","cPMIPch0"), ("Max","Max.Baker@knights.ucf.edu","yy-91Iyq"), ("Olivia","Olivia.Bell@ufl.edu","S-ZV9on4"), ("Hannah","Hannah.Duncan@usf.edu","X9fx9XWw"), ("Anne","Anne.Robertson@uwf.edu","r?kl5.hj")
  , ("Vanessa","Vanessa.Turner@uef.edu","x0X#UzW6"), ("Cameron","Cameron.Ross@fullsail.edu","jWga#gNL"), ("Audrey","Audrey.Forsyth@valencia.edu","aXg1gxrE"), ("Kylie","Kylie.Allan@fiu.edu","-hBP9omY"), ("Katherine","Katherine.Mitchell@fgu.edu","tgSkldXV"), ("Yvonne","Yvonne.McDonald@famu.edu","eOmUAswg")
  , ("Paul","Paul.MacLeod@knights.ucf.edu","4PSpv699"), ("Boris","Boris.Ferguson@ufl.edu","NxGmgN5N"), ("Lily","Lily.Nolan@usf.edu","?L.EYcBX"), ("Faith","Faith.Scott@uwf.edu",".DCZEQAc"), ("Joanne","Joanne.Wilson@uef.edu","9R08lD82"), ("Lucas","Lucas.Smith@fullsail.edu","b2D,A.TN")
  , ("Cameron","Cameron.Fisher@valencia.edu","Cp!zpvNA"), ("Irene","Irene.Grant@fiu.edu","h4lO5zxQ"), ("Fiona","Fiona.Hunter@fgu.edu","ThhtuuvU"), ("Gordon","Gordon.Baker@famu.edu","qshTQjf1"), ("Jan","Jan.Forsyth@knights.ucf.edu","2#6xIB1T"), ("Caroline","Caroline.Clarkson@ufl.edu","RgQd5B?-")
  , ("Steven","Steven.Gibson@usf.edu","RvaYqVU1"), ("Alexandra","Alexandra.Miller@uwf.edu","UilFgM,R"), ("Deirdre","Deirdre.Glover@uef.edu",".3eGNK18"), ("Elizabeth","Elizabeth.Henderson@fullsail.edu","U5PXAT8e"), ("Joan","Joan.Ellison@valencia.edu","hq-,3ZwQ"), ("Justin","Justin.Russell@fiu.edu","wuki?ECw")
  , ("Phil","Phil.Carr@fgu.edu","tePe4bi3"), ("Charles","Charles.Coleman@famu.edu","rLDyQwl#"), ("Jonathan","Jonathan.May@knights.ucf.edu","bZbKJ3JT"), ("Matt","Matt.Randall@ufl.edu","eD8gAMu."), ("Melanie","Melanie.May@usf.edu","#nj18hUi"), ("Michael","Michael.Davies@uwf.edu","Qc7pUn3Z")
  , ("Anthony","Anthony.Underwood@uef.edu","!Wq?ef?f"), ("Blake","Blake.Skinner@fullsail.edu","s74ZQBSE"), ("Andrew","Andrew.Abraham@valencia.edu","-n03'6tb"), ("Jake","Jake.Hamilton@fiu.edu","c,Q.niK."), ("Sebastian","Sebastian.Lewis@fgu.edu","ill.odD#"), ("Robert","Robert.James@famu.edu","Thro?mb3")
  , ("Charles","Charles.Wilson@knights.ucf.edu","4?3fxv30"), ("Alison","Alison.Coleman@ufl.edu","LzKFJVRz"), ("Chloe","Chloe.Edmunds@usf.edu","#XTgrUR6"), ("Lucas","Lucas.Sharp@uwf.edu","jyrk4?Yl"), ("Ava","Ava.Hodges@uef.edu","ST4ThjjW"), ("Anthony","Anthony.Poole@fullsail.edu","!Z.tO?Fw")
  , ("Jake","Jake.Johnston@valencia.edu","G-8ndNVI"), ("Ruth","Ruth.Newman@fiu.edu","DS024AqH"), ("Peter","Peter.Bower@fgu.edu","b6''rt08"), ("Lily","Lily.Bell@famu.edu","i9UNiel#"), ("Lauren","Lauren.Knox@knights.ucf.edu","ee9Mg9ts"), ("Jacob","Jacob.Butler@ufl.edu","uF'XZTz5")
  , ("Wanda","Wanda.Bower@usf.edu","Jb!#hWnw"), ("Robert","Robert.Murray@uwf.edu",".1C-dCJ0"), ("Anthony","Anthony.Thomson@uef.edu","-i.zIi2f"), ("Frank","Frank.Allan@fullsail.edu","AI43nW7b"), ("Ava","Ava.Langdon@valencia.edu","ctFd32YP"), ("Virginia","Virginia.Lawrence@fiu.edu","'cqYbol9")
  , ("Adrian","Adrian.Russell@fgu.edu","7IIoD05S"), ("Alexander","Alexander.Johnston@famu.edu","Z?iG!5At"), ("Virginia","Virginia.Sutherland@knights.ucf.edu","F7A9WwEU"), ("Jessica","Jessica.Walker@ufl.edu","ksVfN3Er"), ("Joan","Joan.Cornish@usf.edu","oX-#9!DE"), ("Anne","Anne.Carr@uwf.edu","jx.e'Aw1")
  , ("Ella","Ella.Fraser@uef.edu","LyiqFc9'"), ("Joanne","Joanne.Knox@fullsail.edu","k8OBeh#4"), ("Amy","Amy.Vance@valencia.edu","nrcaTZka"), ("Nathan","Nathan.Butler@fiu.edu","klV3fEIP"), ("Julian","Julian.Powell@fgu.edu","rnMF9Hs!"), ("Jane","Jane.Payne@famu.edu","o.fTUU,D")
  , ("Sally","Sally.Powell@knights.ucf.edu","7qF'NOH."), ("David","David.Churchill@ufl.edu","A3sY.SJG"), ("Alexandra","Alexandra.Powell@usf.edu","t97dNg0."), ("Wendy","Wendy.Underwood@uwf.edu","d3UHU4YQ"), ("Evan","Evan.Langdon@uef.edu","iC?9rU9r"), ("Piers","Piers.Vaughan@fullsail.edu","Z-avQ7?S")
  , ("Olivia","Olivia.Lyman@valencia.edu","mp5RAwCK"), ("Carl","Carl.Metcalfe@fiu.edu","WM43-'Yj"), ("Andrea","Andrea.Peake@fgu.edu","wcZXwOHE"), ("Stephen","Stephen.Davidson@famu.edu","hWX?rDxW"), ("Gavin","Gavin.Payne@knights.ucf.edu","f0oC-WWz"), ("Virginia","Virginia.Cornish@ufl.edu","UyHxlOI6")
  , ("Amy","Amy.MacDonald@usf.edu","hxLxwP!k"), ("Joe","Joe.Graham@uwf.edu","uJ?9x#eu"), ("Jessica","Jessica.Henderson@uef.edu","AbT7EY4F"), ("Nicola","Nicola.Jackson@fullsail.edu","ebe9DVg0"), ("Melanie","Melanie.Langdon@valencia.edu","Wry4MQ3O"), ("Joseph","Joseph.Terry@fiu.edu","hd8WKD-0")
  , ("Andrea","Andrea.Baker@fgu.edu","C?-Wevcd"), ("Emily","Emily.King@famu.edu","!jkDGkhf"), ("Nicholas","Nicholas.Baker@knights.ucf.edu","AdVJR5di"), ("Anna","Anna.Walker@ufl.edu","ikbV0aDS"), ("Dorothy","Dorothy.Grant@usf.edu","0PfQhXlr"), ("Caroline","Caroline.Nolan@uwf.edu","'vx97Njt")
  , ("Stephen","Stephen.Blake@uef.edu","!kqEnZgS"), ("Michael","Michael.Vance@fullsail.edu","kb165DBa"), ("David","David.Gibson@valencia.edu","SxJy6EzX"), ("Phil","Phil.Gray@fiu.edu","DH3Mb,2E"), ("Evan","Evan.Mills@fgu.edu","ztB'FRS2"), ("Melanie","Melanie.Henderson@famu.edu","xASdaJF2")
  , ("Luke","Luke.Paige@knights.ucf.edu","6SjFov64"), ("Donna","Donna.Taylor@ufl.edu","jSkIEzX#"), ("Jake","Jake.Short@usf.edu","Sg'zybXj"), ("Dorothy","Dorothy.Lawrence@uwf.edu",",0LWCXP1"), ("Paul","Paul.Vance@uef.edu","QoxAcMGt"), ("Heather","Heather.Ferguson@fullsail.edu","1ebKJPeB")
  , ("Angela","Angela.McGrath@valencia.edu","ZrL5k#M#"), ("Jasmine","Jasmine.Glover@fiu.edu","GrRKWus1"), ("Lillian","Lillian.Murray@fgu.edu","1KGUOArW"), ("Paul","Paul.Hodges@famu.edu","yL?TIUA7"), ("Simon","Simon.Parsons@knights.ucf.edu","IIxr.9SX"), ("Diane","Diane.Quinn@ufl.edu","e3qMUGot")
  , ("Luke","Luke.Campbell@usf.edu","fr2M,X32"), ("Amelia","Amelia.Campbell@uwf.edu","ScV2qshF"), ("Ryan","Ryan.Sutherland@uef.edu","Wn8fscsc"), ("Gordon","Gordon.Forsyth@fullsail.edu","MnvhpMrR"), ("Caroline","Caroline.Nash@valencia.edu","YmMuixIK"), ("Warren","Warren.Lewis@fiu.edu","3hxipKx4")
  , ("Charles","Charles.Sanderson@fgu.edu","gm2BHBWK"), ("Tim","Tim.King@famu.edu","YNpJxCxP"), ("Phil","Phil.Cameron@knights.ucf.edu","3#dRFqHG"), ("Virginia","Virginia.Quinn@ufl.edu","uumKXpSa"), ("Kimberly","Kimberly.Hemmings@usf.edu","AxmyTA!J"), ("Keith","Keith.Bell@uwf.edu","n0YILN5P")
  , ("Wendy","Wendy.Alsop@uef.edu","qdppWCv'"), ("Ian","Ian.Forsyth@fullsail.edu","x#DXHQnd"), ("Christopher","Christopher.Brown@valencia.edu","RsH6sGSz"), ("Max","Max.Gray@fiu.edu","9FW3T8xI"), ("Ella","Ella.Parsons@fgu.edu","11Hhe1xA"), ("Blake","Blake.Dyer@famu.edu","ls-T-yaL")
  , ("Ryan","Ryan.Gibson@knights.ucf.edu","rvDnes-m"), ("Una","Una.Ferguson@ufl.edu","w-.0h!j1"), ("Katherine","Katherine.Jones@usf.edu","aXvTYd-m"), ("Zoe","Zoe.Skinner@uwf.edu","VLM2RuD2"), ("Christian","Christian.Newman@uef.edu","Lk#!C1cN"), ("Caroline","Caroline.McGrath@fullsail.edu","Owy'T3R3")
  , ("Anne","Anne.Paige@valencia.edu","TZB'jPhc"), ("Tracey","Tracey.Nash@fiu.edu","eBrnOF1u"), ("James","James.Thomson@fgu.edu","d4I6tjvz"), ("Jasmine","Jasmine.Morrison@famu.edu","LX0e9-E,"), ("Victoria","Victoria.Hardacre@knights.ucf.edu","Zn2#pCP."), ("Sue","Sue.Baker@ufl.edu","Qx,kSuNI")
  , ("Eric","Eric.Davies@usf.edu","uEcNygHr"), ("Chloe","Chloe.Mackenzie@uwf.edu","ripCvWg9"), ("Felicity","Felicity.Marshall@uef.edu","ONlryuBk"), ("Joseph","Joseph.Hughes@fullsail.edu","EC!iOpgH"), ("Robert","Robert.Vaughan@valencia.edu","dlhy6PmL"), ("Vanessa","Vanessa.Randall@fiu.edu","bWI6bg6Z")
  , ("Emily","Emily.Mackenzie@fgu.edu","lG4B#F#Q"), ("Neil","Neil.Short@famu.edu","2U#d5fO7"), ("Amy","Amy.Robertson@knights.ucf.edu","GOY,85D0"), ("Stewart","Stewart.Thomson@ufl.edu","fGXxYau?"), ("Trevor","Trevor.Rutherford@usf.edu","8fKoz7ic"), ("Jessica","Jessica.Short@uwf.edu","GJmQd-,S")
  , ("Jake","Jake.Arnold@uef.edu","erQ!N5H6"), ("Emily","Emily.MacLeod@fullsail.edu",",Gfvh2QX"), ("Dominic","Dominic.Morrison@valencia.edu","idkvVm2Q"), ("Christopher","Christopher.Randall@fiu.edu","iqQ-fM'l"), ("Stephen","Stephen.Black@fgu.edu","E1KkR4GY"), ("Jacob","Jacob.Mackenzie@famu.edu","2G?-7b69")
  , ("Boris","Boris.McGrath@knights.ucf.edu","?zSH?-6U"), ("Benjamin","Benjamin.Parsons@ufl.edu","vi6o70RU"), ("Joshua","Joshua.Graham@usf.edu","odxn8eVs"), ("David","David.Mackenzie@uwf.edu","XPtmdLNk"), ("Jake","Jake.Miller@uef.edu","-e4Ig.wF"), ("Olivia","Olivia.May@fullsail.edu","ZiZ6MkR!")
  , ("Kevin","Kevin.Wilson@valencia.edu","Wg1gn'EC"), ("Eric","Eric.Parr@fiu.edu","GQ,p1iS2"), ("Piers","Piers.Bailey@fgu.edu","C2up3MsJ"), ("Austin","Austin.Martin@famu.edu","Xa1KrklC"), ("Ian","Ian.Roberts@knights.ucf.edu","rVMOYfr4"), ("Luke","Luke.Nash@ufl.edu","uqOSgGK.")
  , ("William","William.Duncan@usf.edu","lpc4yYJZ"), ("Max","Max.Mitchell@uwf.edu","z,U.Qkhe"), ("Sophie","Sophie.Bower@uef.edu","1IKDHgpH"), ("Blake","Blake.Piper@fullsail.edu","eutI!Oz3"), ("Christian","Christian.Watson@valencia.edu","rK0EYNNx"), ("Thomas","Thomas.Jackson@fiu.edu","ng#mdV,i")
  , ("Zoe","Zoe.Abraham@fgu.edu","fypag8BL"), ("Alexandra","Alexandra.Lyman@famu.edu","Im4pmacN"), ("Andrea","Andrea.Mitchell@knights.ucf.edu","IHgxyJg5"), ("Wendy","Wendy.Ince@ufl.edu","gocLvJ2-"), ("Richard","Richard.Dyer@usf.edu","yBXFg22B"), ("Ruth","Ruth.Knox@uwf.edu","sAdbW8H#")
  , ("Evan","Evan.Churchill@uef.edu","eUHq8dm5"), ("James","James.Coleman@fullsail.edu","jOan#dZO"), ("Jack","Jack.Kerr@valencia.edu",".vRv5vl4"), ("Bernadette","Bernadette.Anderson@fiu.edu","AYvr2sfH"), ("Hannah","Hannah.Payne@fgu.edu","cJ69i'wP"), ("Olivia","Olivia.Bower@famu.edu","#QmYd1.R")
  , ("Irene","Irene.Springer@knights.ucf.edu","KcfrnnoP"), ("Emily","Emily.Rees@ufl.edu","BaSpeJh3"), ("Jane","Jane.Ball@usf.edu","!YnvV9aH"), ("Emma","Emma.Cameron@uwf.edu","AMxLT#NV"), ("Jan","Jan.Abraham@uef.edu","leEq#Cn#"), ("Julian","Julian.Thomson@fullsail.edu","3QLNAzZg")
  , ("Lisa","Lisa.Randall@valencia.edu","J',VnfT8"), ("Keith","Keith.Wilson@fiu.edu","8cjKYtfJ"), ("Alexander","Alexander.Powell@fgu.edu","-#37pcZm"), ("Amanda","Amanda.Abraham@famu.edu","nXy,hRjL"), ("Katherine","Katherine.Chapman@knights.ucf.edu","#S!.W5xa"), ("Joshua","Joshua.Kerr@ufl.edu","R#5.e.'h")
  , ("Stephen","Stephen.McDonald@usf.edu","56luthHv"), ("Sean","Sean.Bailey@uwf.edu","6g'tuXb0"), ("Warren","Warren.Taylor@uef.edu","!k-9VRej"), ("Carolyn","Carolyn.Wright@fullsail.edu","eU.,BxQd"), ("Victor","Victor.Dyer@valencia.edu","lJ-aN20d"), ("Eric","Eric.McLean@fiu.edu","I-vT4bOx")
  , ("Una","Una.Mackenzie@fgu.edu","!PgSEdd8"), ("Sue","Sue.Oliver@famu.edu","QB8DhswH"), ("Faith","Faith.Kerr@knights.ucf.edu","l,x2ISQS"), ("Jessica","Jessica.Davidson@ufl.edu","7HKhzW,7"), ("Natalie","Natalie.Lyman@usf.edu","X8sPgoz1"), ("Stephen","Stephen.Coleman@uwf.edu","NHYx1zmj")
  , ("Sophie","Sophie.Wilkins@uef.edu","Zdan8KK1"), ("Victoria","Victoria.Henderson@fullsail.edu","dvG!RdkE"), ("Lucas","Lucas.Graham@valencia.edu","CCNxY6Pl"), ("Jonathan","Jonathan.Forsyth@fiu.edu","8bOuOCEw"), ("Jack","Jack.Vaughan@fgu.edu","s!zW'B6i"), ("Wanda","Wanda.Graham@famu.edu","9m-eP3e,")
  , ("Julian","Julian.Skinner@knights.ucf.edu","mEbRV'nJ"), ("Alexander","Alexander.Fraser@ufl.edu","epy6!6h8"), ("Connor","Connor.Graham@usf.edu","Ps2UdljN"), ("Max","Max.Gill@uwf.edu","ona-.C8a"), ("Victor","Victor.Dowd@uef.edu","gxq022u!"), ("Ian","Ian.Ball@fullsail.edu","LaN'UiTe")
  , ("James","James.Rampling@valencia.edu","PYEtoP5q"), ("Lucas","Lucas.Bond@fiu.edu","nIHMI2fW"), ("Diane","Diane.Mackenzie@fgu.edu","D62z3oJs"), ("Lily","Lily.Bower@famu.edu","expo##uN"), ("Alexander","Alexander.Peake@knights.ucf.edu","YNJJ?bH4"), ("Nathan","Nathan.Roberts@ufl.edu","R1oIBFij")
  , ("Amelia","Amelia.Blake@usf.edu","NAw7MNZE"), ("Sarah","Sarah.Sanderson@uwf.edu","pBKz.nTU"), ("Stephen","Stephen.Miller@uef.edu","?,gf8n1w"), ("Virginia","Virginia.Mills@fullsail.edu","!fI'o7?F"), ("Anne","Anne.Turner@valencia.edu","DQjguuWj"), ("Justin","Justin.Clarkson@fiu.edu","TcPrXkWR")
  , ("Boris","Boris.Johnston@fgu.edu","dT9xLACo"), ("Bernadette","Bernadette.Graham@famu.edu","qQIbfxBU"), ("Chloe","Chloe.Graham@knights.ucf.edu","XE5tSVxl"), ("Trevor","Trevor.Nash@ufl.edu","F4#Qba3L"), ("Ruth","Ruth.Metcalfe@usf.edu","whDU5JhW"), ("Ava","Ava.McLean@uwf.edu","QsqEz9Ww")
  , ("Isaac","Isaac.Roberts@uef.edu","PZaK.F#K"), ("Justin","Justin.Butler@fullsail.edu","qUW0OPad"), ("Nathan","Nathan.Taylor@valencia.edu","!bu8SLIi"), ("Michelle","Michelle.Russell@fiu.edu","t8-haDR1"), ("Kimberly","Kimberly.Grant@fgu.edu","XObc!2II"), ("Claire","Claire.Manning@famu.edu","Oi-'YY!Y")
  , ("Jack","Jack.Short@knights.ucf.edu","WRJITsDX"), ("Justin","Justin.Bailey@ufl.edu","x1OHe36q"), ("Virginia","Virginia.Oliver@usf.edu","k2u'CVhs"), ("Diane","Diane.Duncan@uwf.edu","ofgz6MFl"), ("Sarah","Sarah.Dowd@uef.edu","IHXC4c0n"), ("Brandon","Brandon.Chapman@fullsail.edu","9er2nR-K")
  , ("Thomas","Thomas.Campbell@valencia.edu","QgF2k1tR"), ("Stephanie","Stephanie.Ferguson@fiu.edu","4.pb1wqf"), ("Sarah","Sarah.Lawrence@fgu.edu","ln.t,IJC"), ("Jason","Jason.Robertson@famu.edu","ZytrwQkJ"), ("Stephanie","Stephanie.Forsyth@knights.ucf.edu","1jkVDE1c")
  , ("Pippa","Pippa.Henderson@ufl.edu","9xYOE4BY"), ("Christian","Christian.MacDonald@usf.edu","i0J9F1xY"), ("Victoria","Victoria.Mitchell@uwf.edu","RzyxRP!Q"), ("Blake","Blake.Roberts@uef.edu","AL8uhDK."), ("Chloe","Chloe.Taylor@fullsail.edu","!ivxPk3R"), ("Warren","Warren.Hudson@valencia.edu","32WK8Pf1")
  , ("Tracey","Tracey.Hamilton@fiu.edu","vCPJLHk7"), ("Ava","Ava.Miller@fgu.edu","rB##'GF5"), ("Katherine","Katherine.Peake@famu.edu","V2w!po2e"), ("Anne","Anne.Paterson@knights.ucf.edu","waIoMw,."), ("Hannah","Hannah.Poole@ufl.edu","9c3Fwysy"), ("Rachel","Rachel.Scott@usf.edu","xR?x'#5m")
  , ("Rebecca","Rebecca.Kerr@uwf.edu","vrAV?T31"), ("Frank","Frank.Quinn@uef.edu","zb0lhwBv"), ("Amanda","Amanda.Blake@fullsail.edu","mB0CeqDR"), ("Christopher","Christopher.Cameron@valencia.edu","AVWoUIoA"), ("Piers","Piers.Lawrence@fiu.edu","yehr4J-m"), ("Alexandra","Alexandra.Wright@fgu.edu","9BMyIuKU")
  , ("Dominic","Dominic.Quinn@famu.edu","SQi2KfA6"), ("Jessica","Jessica.Ferguson@knights.ucf.edu","qZ80BU6d"), ("John","John.Cameron@ufl.edu","u.Fe9oJX"), ("Adam","Adam.Payne@usf.edu","N1h7e!At"), ("Olivia","Olivia.Welch@uwf.edu","Oa-FHpeP"), ("Vanessa","Vanessa.Roberts@uef.edu","gBx.b3WP")
  , ("Jason","Jason.Davies@fullsail.edu","7ByeHT1i"), ("Wanda","Wanda.Taylor@valencia.edu","zVR8y3Pf"), ("Thomas","Thomas.Baker@fiu.edu",",XfrbJGT"), ("Carolyn","Carolyn.Edmunds@fgu.edu","qB127fo?"), ("Nicholas","Nicholas.Ogden@famu.edu","ph!D09.2"), ("Samantha","Samantha.Lambert@knights.ucf.edu","Y-KFxub#")
  , ("Carolyn","Carolyn.Piper@ufl.edu","aWkCEj7i"), ("Donna","Donna.Hodges@usf.edu",",lPed'9#"), ("Olivia","Olivia.North@uwf.edu","dT'Phk5j"), ("Julia","Julia.Parsons@uef.edu","#qUjyFVS"), ("Richard","Richard.Paige@fullsail.edu","tY9OGZzk"), ("Richard","Richard.Oliver@valencia.edu","LPe11J?p")
  , ("Paul","Paul.Quinn@fiu.edu","O,CA8KN,"), ("Thomas","Thomas.Scott@fgu.edu",".WtqBBf0"), ("James","James.Lyman@famu.edu","SU0ubRrp"), ("Sarah","Sarah.Davidson@knights.ucf.edu","uHldXLPf"), ("Ian","Ian.Hughes@ufl.edu","EUJd!Ppp"), ("Connor","Connor.Avery@usf.edu","uPS'xdDZ")
  , ("Steven","Steven.Rees@uwf.edu","XG5f?rUu"), ("Julian","Julian.Murray@uef.edu","iNajbxzc"), ("Fiona","Fiona.North@fullsail.edu","P3il!,iM"), ("Connor","Connor.Newman@valencia.edu","WA'ltZO4"), ("Simon","Simon.Henderson@fiu.edu","2W!RX'Cd"), ("Heather","Heather.Mackay@fgu.edu","tVwH'NC5")
  , ("Joshua","Joshua.Duncan@famu.edu",".ODiXYs1"), ("Claire","Claire.James@knights.ucf.edu","wotigbpl"), ("Edward","Edward.Butler@ufl.edu","7ZB2Cot."), ("Julian","Julian.Taylor@usf.edu","HdC8hg2V"), ("Donna","Donna.Nash@uwf.edu","KYh6EIeG"), ("Simon","Simon.Hodges@uef.edu","0BPiyNu!")
  , ("Megan","Megan.Powell@fullsail.edu","9T!t-CYP"), ("Gavin","Gavin.Allan@valencia.edu","-wW'51,l"), ("Tracey","Tracey.Pullman@fiu.edu","CApoZN8L"), ("Keith","Keith.Morgan@fgu.edu","yu7PB.Ra"), ("Michelle","Michelle.Piper@famu.edu","ePI8o3'N"), ("Gavin","Gavin.Knox@knights.ucf.edu",".LrL3Mw!")
  , ("Madeleine","Madeleine.Lambert@ufl.edu","v-3I0?AR"), ("Piers","Piers.Marshall@usf.edu","xK'.dGOo"), ("Edward","Edward.Walker@uwf.edu","a25iNqVX"), ("Dan","Dan.Henderson@uef.edu","Xmj'5zJN"), ("Jennifer","Jennifer.Roberts@fullsail.edu","9n4qMA98"), ("Stewart","Stewart.Ferguson@valencia.edu","pIO0Q27Y")
  , ("Rose","Rose.Burgess@fiu.edu",",',yjk-B"), ("Gordon","Gordon.Allan@fgu.edu","qVcwkllk"), ("Leah","Leah.Vaughan@famu.edu","7VZejwo4"), ("Carol","Carol.Ellison@knights.ucf.edu",",ADnIuFU"), ("Bernadette","Bernadette.Peters@ufl.edu","Z2n?7u7n"), ("Diana","Diana.North@usf.edu","UZTcBf,M")
  , ("Sophie","Sophie.Walsh@uwf.edu","sLAneYbW"), ("Theresa","Theresa.Glover@uef.edu","UOymPD-N"), ("Una","Una.Bailey@fullsail.edu","yZ9gNc0I"), ("Jan","Jan.Langdon@valencia.edu","tfurnY,B"), ("Michelle","Michelle.Hill@fiu.edu","NwoNwtkv"), ("Wanda","Wanda.Oliver@fgu.edu","-m-PCcCx")
  , ("Tracey","Tracey.North@famu.edu","MAcQVx6F"), ("Michael","Michael.Walsh@knights.ucf.edu","9XENU10R"), ("Wendy","Wendy.Chapman@ufl.edu","kvPEYUMP"), ("Maria","Maria.Mackenzie@usf.edu","o6y8AOeM"), ("Joanne","Joanne.Sutherland@uwf.edu","l#lbtFbz"), ("Colin","Colin.Jackson@uef.edu","om1ZPc.M")
  , ("Joe","Joe.Ball@fullsail.edu","7Cynh3QF"), ("Isaac","Isaac.McLean@valencia.edu","9?nmmqfy"), ("Alison","Alison.Randall@fiu.edu","rQcdC32v"), ("Joan","Joan.Reid@fgu.edu","0FGvLRRP"), ("Alan","Alan.Wilson@famu.edu","ITblfpN9"), ("Boris","Boris.Miller@knights.ucf.edu","eBRDg#WH")
  , ("Luke","Luke.Parr@ufl.edu","m-pslldg"), ("Sue","Sue.Tucker@usf.edu","8OisHsvA"), ("Rose","Rose.Kerr@uwf.edu","wldIBR#Z"), ("Stewart","Stewart.Payne@uef.edu","gp.AU8eM"), ("Keith","Keith.Sanderson@fullsail.edu","9Wc62I7."), ("Jasmine","Jasmine.Mackenzie@valencia.edu","Gst..rvv")
  , ("Rose","Rose.Wallace@fiu.edu","YmWU4rWj"), ("Una","Una.Hunter@fgu.edu","KA?saUwe"), ("Melanie","Melanie.Duncan@famu.edu","QC0Z7NeQ"), ("Max","Max.Marshall@knights.ucf.edu","C1.ZknFT"), ("Paul","Paul.Johnston@ufl.edu","vN,kf3JR"), ("Jacob","Jacob.Walsh@usf.edu","cXFFO8'M")
  , ("Ella","Ella.Kelly@uwf.edu","QYAFkXCc"), ("Boris","Boris.Hart@uef.edu","P.WhR3F4"), ("Amanda","Amanda.Martin@fullsail.edu","?tVwE!gS"), ("Julian","Julian.Pullman@valencia.edu","eB4oh?u'"), ("Chloe","Chloe.MacLeod@fiu.edu","ywQRTfWL"), ("Rose","Rose.MacDonald@fgu.edu","IrhUQVhD")
  , ("Thomas","Thomas.Howard@famu.edu",".VpG7#Li"), ("Jake","Jake.Rees@knights.ucf.edu","#6YJIsJ?"), ("Rose","Rose.Greene@ufl.edu","4EaZYcn?"), ("Zoe","Zoe.Langdon@usf.edu","HxdnhmgG"), ("Theresa","Theresa.Dyer@uwf.edu","nF!ImVK8"), ("Trevor","Trevor.Lawrence@uef.edu","eoz5fQfL")
  , ("Mary","Mary.Vaughan@fullsail.edu","b#2z3MtX"), ("Mary","Mary.Lyman@valencia.edu","pfT!LVqi"), ("Isaac","Isaac.Reid@fiu.edu","qvOunDJv"), ("Joseph","Joseph.Ross@fgu.edu","aLdiqf9N"), ("Ian","Ian.Lyman@famu.edu","ZbsU?zQu");
